    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <AppText style={styles.headerTitle}>Syarat & Ketentuan</AppText>
            </View>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                <AppText style={styles.title}>Syarat Dan Ketentuan Umum</AppText>
                ...
                <AppText style={styles.sectionTitle}>Titip Jual (Consignment)</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Larangan Beriklan</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.subSectionTitle}>Kebiakan Khusus Selama Pandemi COVID-19</AppText>
                <AppText style={styles.paragraph}>
                    Berikut daftar iklan / produk yang dilarang tayang selama pandemi COVID-19 :
                </AppText>
                <AppText style={styles.listItem}>• Surat Bebas COVID-19</AppText>
                <AppText style={styles.listItem}>• Alat Pelindung Diri (APD) Baju Hazmat</AppText>
                <AppText style={styles.listItem}>• Alat Rapid Test COVID-19</AppText>
                <AppText style={styles.listItem}>• Alat Swab PCR Test COVID-19</AppText>
                <AppText style={styles.listItem}>• Tanah Pemakaman COVID-19 dan jasanya</AppText>

                <AppText style={styles.sectionTitle}>Umum</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.listItem}>• Iklan yang merugikan pihak ketiga dalam bentuk apapun</AppText>
                <AppText style={styles.listItem}>• Benda-benda atau jasa yang tergolong sensitif dan salah secara moral.</AppText>
                <AppText style={styles.listItem}>• Barang hasil kejahatan demi terbentuk nya aplikasi dan website yg terbaik kami melarang penayangan iklan sbb :</AppText>
                <AppText style={styles.subListItem}>   - Iklan yang menduplikasi iklan lain yang sudah aktif</AppText>
                <AppText style={styles.subListItem}>   - Iklan yang mengarahkan ke platform, situs, jasa, atau kantor pesaing</AppText>
                <AppText style={styles.subListItem}>   - Iklan dengan kategori yang tidak sesuai</AppText>
                <AppText style={styles.subListItem}>   - Iklan dengan foto buram, terbalik, atau bermutu jelek</AppText>
                <AppText style={styles.subListItem}>   - Iklan dengan foto, deskripsi, dan/atau judul yang tidak sesuai dengan produk/jasa yang dijual.</AppText>

                <AppText style={styles.sectionTitle}>Iklan Dengan Materi Dewasa</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan yang Merugikan Pihak / Kelompok Tertentu</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan yang Melanggar Hak Kekayaan Intelektual Atau Hak Pihak Ketiga</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan Narkoba, Obat-obatan, Makanan, Da Minuman Tertentu</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan Dengan Materi Kekerasan</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan Senjata, Militer, Dan Peledak</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Iklan yang Memungkinkan Perilaku Penipuan Atau Tidak Jujur</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Lain-lain</AppText>
                <AppText style={styles.paragraph}>
