    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <AppText style={styles.headerTitle}>Kebijakan Privasi</AppText>
            </View>
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <AppText style={styles.sectionTitle}>Pengumpulan Informasi Pengguna</AppText>
                <AppText style={styles.paragraph}>
                ...
                <AppText style={styles.sectionTitle}>Tindakan Teknis dan Organisasi & Pemrosesan Keamanan</AppText>
                <AppText style={styles.paragraph}>
