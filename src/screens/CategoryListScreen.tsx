...
const CategoryListScreen = () => {
  ...
  const calculateColumnWrapperStyle = () => {
    const lastRowItems = categories.length % NUM_COLUMNS;
    if (lastRowItems === 0 || lastRowItems === NUM_COLUMNS) {
      // Full row or no items
      return { justifyContent: 'flex-start' };
    }
    // Incomplete last row - center it
      ...
      {loading ? (
        ...
        >
          <FlatList
            ...
            columnWrapperStyle={calculateColumnWrapperStyle()}
          ...
          {loadingSub ? (
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <AppText style={styles.subcategoryText}>
                    {item.name?.toUpperCase()}
                  </AppText>
